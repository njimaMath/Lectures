...
\mondai{問2}集合の規則に従って $A\cap (B \cup C) = (A \cap B) \cup (A \cap C)$を示せ。つまり
\[
...
\mondai{問3}(1) $f,g$ が全単射であれば、合成 $g\circ f$ も全単射であることを証明せよ。
\par\noindent\hspace*{2.8em}(2) 合成 $g\circ f$ が全射であっても、$f$ が全射となるとは限らないことを示せ。
